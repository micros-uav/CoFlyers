function [command_upper_s,control_mode_s,will_s_for_visual] =...
    Vasarhelyi_will_module_generate_desire(t,states,parameters_flocking,map_lines,map_grid,parameters_sensor_env,smaple_time)
...
[r_com,~,tau_will] = Vasarhelyi_will_module_parameters_deal(parameters_flocking);
...
will_s = will_s * exp(-smaple_time/tau_will);
