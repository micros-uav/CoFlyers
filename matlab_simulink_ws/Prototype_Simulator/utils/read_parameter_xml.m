...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function write_swarm_module_generate_desire(dir_name, file_name, field_names)
        ...
        for i = 1:length(field_names)
            ...
            fprintf(file_id,'\t\t[command_upper_s,control_mode_s] = %s_module_generate_desire(t, states, sample_time, sensor_data_s);\n',field_names{i});
        end
    ...
    function write_subswarm_for_file(dir_name, file_name, subswarm_name, values, values_name)
        ...
        if ~exist(file_fullpath,'file')
            ...
            fprintf(file_id,['function [command_upper_s,control_mode_s] =',...
                '%s_module_generate_desire(t, states, sample_time, sensor_data_s)\n'],subswarm_name);
